...
public class ProxyTest extends TestBase {
    ...
    public void options() {
        ...
        options.setCertificateCheck(
                new Transport.CertificateCheckCb() {
                    @Override
        ...
        options.setCredentials(
                new Credential.AcquireCb() {
                    @Override
                    public Credential accept(String url, String usernameFromUrl, int allowedTypes)
                            throws GitException {
